    ...
    return (
        <div className="relative">
            <input
                ...
                type={type}
                ref={localRef}
                className={"block px-2.5 pb-2.5 pt-4 w-full h-11 text-gray-900 bg-white rounded border border-gray-400 appearance-none focus:outline-blue-500 focus:ring-blue-500 focus:border-blue-500 peer " + className} placeholder=" " />
